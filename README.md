...
- [MetaMask/controllers](https://github.com/MetaMask/controllers) ([v16.0.0](https://github.com/MetaMask/controllers/releases/tag/v16.0.0), today) - Collection of platform-agnostic modules for creating secure data models for cryptocurrency wallets
