...
- [rickycodes/proxmox_znc](https://github.com/rickycodes/proxmox_znc) - A small Proxmox host-side installer that creates an Alpine LXC and bootstraps a basic ZNC bounce. (6 days ago)
...
- [rickycodes/proxmox_znc](https://github.com/rickycodes/proxmox_znc) ([v0.1.0](https://github.com/rickycodes/proxmox_znc/releases/tag/v0.1.0), 6 days ago) - A small Proxmox host-side installer that creates an Alpine LXC and bootstraps a basic ZNC bounce.
