...
- [MetaMask/controllers](https://github.com/MetaMask/controllers) ([v18.0.0](https://github.com/MetaMask/controllers/releases/tag/v18.0.0), 1 day ago) - Collection of platform-agnostic modules for creating secure data models for cryptocurrency wallets
- [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) ([v3.5.0](https://github.com/MetaMask/metamask-mobile/releases/tag/v3.5.0), 2 days ago) - Mobile web browser providing access to websites that use the Ethereum blockchain
...
- [Add tgz-check shellscript](https://github.com/MetaMask/metamask-mobile/pull/3361) on [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) (1 day ago)
- [move cron over](https://github.com/rickycodes/metamask-extension/pull/4) on [rickycodes/metamask-extension](https://github.com/rickycodes/metamask-extension) (2 days ago)
