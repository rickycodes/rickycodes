...
- [MetaMask/controllers](https://github.com/MetaMask/controllers) ([v32.0.0](https://github.com/MetaMask/controllers/releases/tag/v32.0.0), today) - Collection of platform-agnostic modules for creating secure data models for cryptocurrency wallets
- [MetaMask/snaps-monorepo](https://github.com/MetaMask/snaps-monorepo) ([v0.22.2](https://github.com/MetaMask/snaps-monorepo/releases/tag/v0.22.2), today) - Monorepo for Snaps dependencies.
