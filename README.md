...
- [MetaMask/controllers](https://github.com/MetaMask/controllers) ([v12.1.0](https://github.com/MetaMask/controllers/releases/tag/v12.1.0), 1 day ago) - Collection of platform-agnostic modules for creating secure data models for cryptocurrency wallets
...
- [Update `ethereumjs-tx` to `@ethereumjs/tx` to support EIP1559 transactions](https://github.com/MetaMask/web3-provider-engine/pull/377) on [MetaMask/web3-provider-engine](https://github.com/MetaMask/web3-provider-engine) (3 days ago)
