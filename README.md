...
- [MetaMask/metamask-extension](https://github.com/MetaMask/metamask-extension) ([v10.10.2](https://github.com/MetaMask/metamask-extension/releases/tag/v10.10.2), 4 days ago) - :globe_with_meridians: :electric_plug: The MetaMask browser extension enables browsing Ethereum blockchain enabled websites
...
- [Add `./scripts/create-release.sh` to better automate releases](https://github.com/MetaMask/metamask-mobile/pull/3832) on [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) (3 days ago)
</details>
