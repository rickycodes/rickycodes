...
- [MetaMask/core](https://github.com/MetaMask/core) ([v146.0.0](https://github.com/MetaMask/core/releases/tag/v146.0.0), 1 day ago) - This monorepo is a collection of packages used across multiple MetaMask clients
- [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) ([v7.20.1](https://github.com/MetaMask/metamask-mobile/releases/tag/v7.20.1), 5 days ago) - Mobile web browser providing access to websites that use the Ethereum blockchain
