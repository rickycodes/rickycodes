...
- [rickycodes/ftse-rs](https://github.com/rickycodes/ftse-rs) - scrape and filter hl.co.uk market summaries (3 days ago)
...
- [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) ([3.3.0](https://github.com/MetaMask/metamask-mobile/releases/tag/3.3.0), 1 day ago) - Mobile web browser providing access to websites that use the Ethereum blockchain
- [MetaMask/controllers](https://github.com/MetaMask/controllers) ([v15.1.0](https://github.com/MetaMask/controllers/releases/tag/v15.1.0), 1 week ago) - Collection of platform-agnostic modules for creating secure data models for cryptocurrency wallets
...
- [Update README.md](https://github.com/MetaMask/metamask-mobile/pull/3115) on [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) (6 days ago)
