...
- [MetaMask/action-create-release-pr](https://github.com/MetaMask/action-create-release-pr) ([v1.4.0](https://github.com/MetaMask/action-create-release-pr/releases/tag/v1.4.0), 1 day ago) - 
- [rickycodes/card](https://github.com/rickycodes/card) ([v1.6.10](https://github.com/rickycodes/card/releases/tag/v1.6.10), 3 days ago) - npx business card built with rust targeting wasm
- [MetaMask/controllers](https://github.com/MetaMask/controllers) ([v30.0.1](https://github.com/MetaMask/controllers/releases/tag/v30.0.1), 5 days ago) - Collection of platform-agnostic modules for creating secure data models for cryptocurrency wallets
...
- [add scripts/browserstack-upload.js](https://github.com/MetaMask/metamask-mobile/pull/4494) on [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) (5 days ago)
- [Add missing subtitles for secret recovery phrase](https://github.com/MetaMask/metamask-extension/pull/14943) on [MetaMask/metamask-extension](https://github.com/MetaMask/metamask-extension) (5 days ago)
