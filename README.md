...
- [MetaMask/KeyringController](https://github.com/MetaMask/KeyringController) ([v13.0.1](https://github.com/MetaMask/KeyringController/releases/tag/v13.0.1), today) - A module for managing groups of Ethereum accounts and using them.
- [MetaMask/core](https://github.com/MetaMask/core) ([v76.0.0](https://github.com/MetaMask/core/releases/tag/v76.0.0), 4 days ago) - This monorepo is a collection of packages used across multiple MetaMask clients
...
- [MetaMask/metamask-mobile](https://github.com/MetaMask/metamask-mobile) ([v7.5.0](https://github.com/MetaMask/metamask-mobile/releases/tag/v7.5.0), 2 weeks ago) - Mobile web browser providing access to websites that use the Ethereum blockchain
...
- [Update README.md](https://github.com/MetaMask/action-npm-publish/pull/55) on [MetaMask/action-npm-publish](https://github.com/MetaMask/action-npm-publish) (1 day ago)
- [Update README.md](https://github.com/MetaMask/action-npm-publish/pull/54) on [MetaMask/action-npm-publish](https://github.com/MetaMask/action-npm-publish) (1 day ago)
